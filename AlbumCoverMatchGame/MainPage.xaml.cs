...
namespace AlbumCoverMatchGame
{
    ...
    public sealed partial class MainPage : Page
    {
            ...
            StorageFolder parent)
        {
            ...
            //for each file that is mp3 add it to the list
            ...
            //for each folder call the function on it self
        ...
        private async Task<List<StorageFile>> PickRandomSongs(ObservableCollection<StorageFile> allSongs)
        {
            ...
            {
                var randomNumber = random.Next(songCount); //Max random number is = to how many songs are there
